        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left space-y-6 animate-fade-up">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-semibold text-foreground leading-tight">
              Tartary
              <br />
              <span className="text-primary">Buckwheat</span>
              <br />
              Tea
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground max-w-lg leading-relaxed">
              Experience the ancient tradition of Soba tea. Pure, naturally caffeine-free, 
              and packed with antioxidants for your wellness journey.
            </p>
