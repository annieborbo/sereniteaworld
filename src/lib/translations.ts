...
export const translations = {
  en: {
    ...
    hero: {
      ...
      title2: 'Buckwheat',
      title3: 'Tea',
      description: 'Our Tartary buckwheat tea is naturally caffeine-free and can be enjoyed any time of day — hot or iced. Available as loose leaf or tea bags.',
      shopNow: 'Shop Now',
  ...
  nl: {
    ...
    hero: {
      ...
      title2: 'Boekweit',
      title3: 'Thee',
      description: 'Onze Tartaarse boekweitthee is van nature cafeïnevrij en kan op elk moment van de dag worden genoten — warm of koud. Verkrijgbaar als losse thee of theezakjes.',
      shopNow: 'Shop Nu',
