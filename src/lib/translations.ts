...
export const translations = {
  en: {
    ...
    hero: {
      ...
      title3: "Tea",
      description:
        "Experience the ancient tradition of Soba tea. Pure, naturally caffeine-free, and packed with antioxidants for your wellness journey.",
      shopNow: "Shop Now",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Yes, our teas are vegan, gluten-free, and contain no carbohydrates, so they fit into a ketogenic diet as well.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, our teas are also very delicious cold! Simply let your brewed tea cool, then place it in the fridge or add ice for a refreshing iced tea experience.",
        },
      ],
    },
    // Newsletter
    newsletter: {
      ...
      description:
        "Subscribe to our newsletter for exclusive offers, brewing tips, and wellness inspiration. Get 10% off your first order!",
  ...
  nl: {
    ...
    hero: {
      ...
      title3: "Thee",
      description:
        "Ervaar de oude traditie van Soba-thee. Puur, van nature cafeïnevrij en boordevol antioxidanten voor jouw welzijnsreis.",
      shopNow: "Shop Nu",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Ja, onze thee is veganistisch, glutenvrij en bevat geen koolhydraten, dus past in een ketogeen dieet.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Ja, onze thee is ook erg lekker koud! Laat uw gezette thee gewoon afkoelen, zet deze in de koelkast of voeg ijs toe voor een verfrissende ijsthee-ervaring.",
        },
      ],
    },
    // Newsletter
    newsletter: {
      ...
      description:
        "Schrijf u in voor onze nieuwsbrief voor exclusieve aanbiedingen, zettippen en welzijnsinspiratie. Krijg 10% korting op uw eerste bestelling!",
